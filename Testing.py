...
def AttBDLSTMS_FCN(X, Y, epochs=30, validation_split=0.2, patience=10):
    ...
    BDLSTM_output = AttentionLSTM(6)(BDLSTM_output)
    ...
    NAME = "TL-6_2-AttBDLSTMS_FCN-{}".format(int(time.time()))
